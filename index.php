...
<html>
    ...
    <body  class="bg">
        <?php if(isset($_SESSION['userlogin'])){if($_SESSION['userlogin']['userid']=="admin"){include 'navbarAdmin.php';} else{include 'navbar.php';}}else{include 'navbar.php';} ?>

        <div class="container-fluid">
          <div id="carouselExampleIndicators" class="carousel slide carousel-fade fade_caro mx-5" data-ride="carousel">
          <ol class="carousel-indicators">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100 imgLog1" src="images/cafe au lait1.png" alt="img1">
                 <div class="carousel-caption d-none d-md-block">
                  <h1 class="imgLog1">Bagel</h1><br>
                   <p>This is not a Donut. 
                     <br>This is a Bagel. Buy now while it's hot.</p>
                   <button  onclick="location.href = 'menu.php';" class="btn buyColor btn-lg rounded-pill imgLog1">Buy Now!</button>
                 </div>
              </div>
              <div class="carousel-item">
                <img class="d-block w-100 imgLog1" src="images/LATTEAJAY.png" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
                  <h1 class="imgLog1">Ensaymada</h1><br>
                   <p>This cheesy creamy goodness will make
                    <br>you craving for more. Order now or you will never
                    <br>know happiness in your lifetime</p>
                   <button class="btn buyColor btn-lg rounded-pill imgLog1">Order Now</button>
                 </div>
              </div>
              <div class="carousel-item">
                <img class="d-block w-100 imgLog1" src="images/Mocha.png" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
                  <h1 class="imgLog1">Croissant</h1><bR>
                   <p>Tasty folded bread rolled into a moon shaped <br>
                     bread. This crispy goodness will make your mouth, <br>
                     asking for more. Get one now!. </p>
                   <button class="btn buyColor btn-lg rounded-pill imgLog1">Get it Now!</button>
                 </div>
              </div>
            </div>
          </div>   
            <div class="row align-items-center fade_body mx-5">
              ...
              <div class="col">
                <blockquote class="blockquote">
                  ...
                  <footer class="blockquote-footer"><cite title="Source Title">M.F.K. Fisher</cite></footer>
                </blockquote>
              </div>
            </div>
          </div>
