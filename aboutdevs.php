...
<html>
    ...
    <body  class="bg">
       <?php include 'navbar.php' ?>
        ...
        <div class="wrapper">
            <h1 class="imgLog1">Our Team</h1>
            <div class="col team">
                <div class="team_member rounded imgLog2">
                    <div class="team_img">
                        <img src="team_img_1/james lopez.png" alt="Team_image">
                    </div>
                    <h3>James Lopez</h3>
                ...
                <div class="team_member rounded imgLog2">
                    <div class="team_img">
                        <img class= "mb-5" src="team_img_1/florian.png" alt="Team_image">
                    </div>
                    <h3>Florian Marteein</h3>
                ...
                <div class="team_member rounded imgLog2">
                    <div class="team_img">
                        <img src="team_img_1/michael cedron.png" alt="Team_image">
                    </div>
                    <h3>Michael</h3>
                ...
                <div class="team_member rounded imgLog2">
                    <div class="team_img">
                        <img src="team_img_1/Sevilleno.png" alt="Team_image">
                    </div>
                    <h3>Joshua</h3>
                ...
                <div class="team_member rounded imgLog2">
                    <div class="team_img">
                        <img src="team_img_1/PAcis.png" alt="Team_image">
                    </div>
                    <h3>Uriel Jeremiah</h3>
